    ...
    it('devrait permettre de rejoindre une room existante', () => {
      return new Promise<void>((resolve) => {
        ...
        clientSocket2.on('gameStarted', (data) => {
          ...
          expect(data.gameState).toHaveProperty('currentTurn')
          expect(data.gameState).toHaveProperty('turnNumber')
          expect(data.gameState).toHaveProperty('you')
          expect(data.gameState).toHaveProperty('opponent')
          expect(data.gameState.you).toHaveProperty('userId')
          expect(data.gameState.you).toHaveProperty('username')
          expect(data.gameState.you).toHaveProperty('score')
